...
const Navbar = () => {
    ...
    const links = (
        <>
            ...
            <NavLink to="/faq" className={({ isActive }) => isActive ? "text-[#2fe517] font-bold" : "text-secondary"}>FAQ</NavLink>
        </>
        // <>
    ...
    return (
        <div className="bg-primary shadow-md  lg:px-8 py-2 sticky top-0 z-50">
